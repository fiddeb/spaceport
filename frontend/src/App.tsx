...
export default function App() {
  ...
  const showDeparturesControls = /^\/(departures|book|confirmation|currencies)/.test(pathname);
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="mx-auto w-full max-w-7xl flex-1 px-6 pt-22 pb-8">
        <Outlet />
      </main>
